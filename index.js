...
(async () => {
  ...
  await page.type('input[data-testid="SearchBox_Search_Input"]', "#tesla", {
    delay: 25,
  });
  ...
  for (let i = 0; i < urls.length; i++) {
    try {
      ...
      await page.waitForTimeout(2000);
      await page.click(
        'div[class="css-18t94o4 css-1dbjc4n r-1niwhzg r-p1n3y5 r-sdzlij r-1phboty r-rs99b7 r-1w2pmg r-1vuscfd r-1dhvaqw r-1fneopy r-o7ynqc r-6416eg r-lrvibr"]'
      );
      await page.waitForTimeout(2000);
      await page.goBack();
    } catch (error) {
